...
import 'package:musify/screens/auth/cloud_backup_screen.dart';
import 'package:musify/screens/auth/login_screen.dart';
  ...
  void _setupRouter() {
    final routes = [
      ...
      GoRoute(
        path: '/register',
        pageBuilder: (context, state) {
          return getPage(child: const RegisterScreen(), state: state);
        },
      ),
      GoRoute(
        path: '/profile',
        pageBuilder: (context, state) {
          return getPage(child: const ProfileScreen(), state: state);
        },
      ),
      GoRoute(
        path: '/cloud-backup',
