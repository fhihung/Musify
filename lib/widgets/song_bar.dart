...
class _SongBarState extends State<SongBar> {
  ...
  List<PopupMenuEntry<String>> _buildMenuItems(
    ...
    // Cache localization strings to avoid accessing context after dispose
    final l10n = context.l10n!;
    final playNext = l10n.playNext;
    final addToLikedSongs = l10n.addToLikedSongs;
    final removeFromLikedSongs = l10n.removeFromLikedSongs;
    final removeFromPlaylist = l10n.removeFromPlaylist;
    final addToPlaylist = l10n.addToPlaylist;
    final removeFromRecentlyPlayed = l10n.removeFromRecentlyPlayed;
          ...
          builder: (_, value, __) {
            return Row(
              children: [
                ...
                const SizedBox(width: 8),
                Text(
                  value ? removeFromLikedSongs : addToLikedSongs,
                ),
              ],
            );
          },
